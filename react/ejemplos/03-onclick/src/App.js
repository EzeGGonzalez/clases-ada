...
class App extends Component {
  ...
  constructor (props) {
    ...
    // siempre que usemos una funcion en un evento (onClick, onChange, onKeyUp, ...)
    // vamos a tener que poner esta linea por cada una de esas funciones
  ...
  render() {
    ...
    return (
      <div>
        ...
        <button onClick={this.handleButtonClick}>Saludar</button>
      </div>
    )
  }
}
